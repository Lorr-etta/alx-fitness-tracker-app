  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <nav className="flex justify-between items-center px-6 py-4 bg-white shadow-md fixed top-0 left-0 right-0 z-10">
        <h1 className="text-green-600 font-bold text-xl">FIGURE 8 Fitness</h1>
        <ul className="flex flex-row space-x-6 text-gray-700">
      ...
      <section className="py-16 px-8 bg-gray-100">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-8">
          {features.map((feature) => (
            <div
              key={feature.id}
              className="bg-white p-6 rounded-lg shadow hover:shadow-lg transform hover:scale-105 transition"
            >
